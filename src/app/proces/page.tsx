...
export const metadata = {
  title: "Procesul de Lucru | David Construct",
  description: "Află etapele procesului de construcție cu David Construct: de la consultanță la predarea casei din lemn la cheie.",
};
