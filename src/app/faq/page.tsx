...
export const metadata = {
  title: "Întrebări Frecvente | David Construct",
  description: "Răspunsuri la cele mai frecvente întrebări despre construcțiile din lemn, proces, materiale și colaborare cu David Construct.",
};
